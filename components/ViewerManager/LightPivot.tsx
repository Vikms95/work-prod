...
export function LightPivot({ pivotKey, id, matrix, children, disableRotations }: Props) {
  ...
  const { handleDrag, handleDragEnd, handleDragStart } = useLightEvents3D(id)
